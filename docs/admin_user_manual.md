...
- 管理者としてログイン中に問診が完了すると、問診結果の登録が完了したタイミングでブラウザのデスクトップ通知でもお知らせされます。
  - 初回ログイン時にブラウザから通知許可を求めるトーストが表示されます。許可するとバックグラウンドにいる場合も OS 標準の通知が届きます。
  - 許可しなかった場合でも、画面右上の通知で完了を確認でき、通知の「問診結果を確認」ボタンから一覧画面を開けます。

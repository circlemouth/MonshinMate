...
_DEFAULT_PROVIDER_ORDER: list[str] = ["ollama", "lm_studio", "openai"]
...
def _is_gcp_enabled() -> bool:
    env_override = os.getenv("MONSHINMATE_ENABLE_GCP_LLM")
    if env_override is not None:
        return _truthy(env_override)
    return _truthy(os.getenv("ENABLE_GCP"))
